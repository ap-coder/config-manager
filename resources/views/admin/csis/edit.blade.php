...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.csi.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.csis.update", [$csi->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group {{ $errors->has('use_dev_channels') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="use_dev_channels" name="use_dev_channels" {{ (isset($csi) && $csi->use_dev_channels) || old('use_dev_channels', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('use_beta_channels') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="use_beta_channels" name="use_beta_channels" {{ (isset($csi) && $csi->use_beta_channels) || old('use_beta_channels', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('use_qa_channels') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="use_qa_channels" name="use_qa_channels" {{ (isset($csi) && $csi->use_qa_channels) || old('use_qa_channels', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('use_production_channels') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="use_production_channels" name="use_production_channels" {{ (isset($csi) && $csi->use_production_channels) || old('use_production_channels', 0) === 1 ? 'checked' : '' }}>
