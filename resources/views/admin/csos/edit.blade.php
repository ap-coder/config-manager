...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.cso.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.csos.update", [$cso->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group {{ $errors->has('use_channel_server_localhost') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="use_channel_server_localhost" name="use_channel_server_localhost" {{ (isset($cso) && $cso->use_channel_server_localhost) || old('use_channel_server_localhost', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('use_default_a') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="use_default_a" name="use_default_a" {{ (isset($cso) && $cso->use_default_a) || old('use_default_a', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('use_default_b') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="use_default_b" name="use_default_b" {{ (isset($cso) && $cso->use_default_b) || old('use_default_b', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('use_aggragation_for_a') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="use_aggragation_for_a" name="use_aggragation_for_a" {{ (isset($cso) && $cso->use_aggragation_for_a) || old('use_aggragation_for_a', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('use_aggragation_for_b') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="use_aggragation_for_b" name="use_aggragation_for_b" {{ (isset($cso) && $cso->use_aggragation_for_b) || old('use_aggragation_for_b', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('use_sync_server_for_a') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="use_sync_server_for_a" name="use_sync_server_for_a" {{ (isset($cso) && $cso->use_sync_server_for_a) || old('use_sync_server_for_a', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('use_sync_server_for_b') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="use_sync_server_for_b" name="use_sync_server_for_b" {{ (isset($cso) && $cso->use_sync_server_for_b) || old('use_sync_server_for_b', 0) === 1 ? 'checked' : '' }}>
